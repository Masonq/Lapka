...
попадают под блокировку; оба варианта поддержаны ниже автоматически по
номеру порта. SMTP_FROM обязательно должен быть адресом на домене,
подтверждённом в Resend, иначе они отклонят отправку.
