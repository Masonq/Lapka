...
| 10 | Search | 🟡 | Вкладки Посты/Люди/Питомцы/Сообщества/События с реальным поиском на каждой (было — только посты, найти человека по имени было вообще нельзя). Нет: вкладки Businesses, filter drawer, recent/saved searches, geo/breed фильтров |
